========================================================================
    WIN32 应用程序：俄罗斯方块 项目概述
========================================================================

应用程序向导已为您创建了此 俄罗斯方块 应用程序。

本文件概要介绍组成 俄罗斯方块 应用程序的每个文件的内容。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 俄罗斯方块.pch 的预编译头 (PCH) 文件和
